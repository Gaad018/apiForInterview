...
0. Вы можете использовать уже созданную базу данных(2) или создать новую(1)
1. :books: Создать базу данных laravel (utf8mb4_unicode_ci) и для заполнения данными, выполнить эти команды:    
```php
php artisan migrate
php artisan db:seed
```
2.:computer: Загрузить дамп базы данных(файл laravel.sql) и выполнить следующие команды:    
```
